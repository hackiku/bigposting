// src/app/home/advertisers/demo/WebsitesDemo.tsx

"use client";

import { useState } from 'react';
import { demoWebsites } from '../data/websites-data';
...
export default function WebsitesDemo() {
	...
	const displayedWebsites = filteredWebsites.slice(0, MAX_RESULTS);

	return (
		<div className="w-full">
			{/* Integrated Search + Results Counter */}
			<WebsiteSearch
				totalResults={filteredWebsites.length}
				displayedResults={displayedWebsites.length}
			/>
