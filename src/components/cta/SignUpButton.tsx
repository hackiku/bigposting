		...
		<Link href={href} passHref>
			...
			>
				...
				<div className="absolute inset-x-0 bottom-0 h-1/3 
					bg-gradient-to-t from-yellow-700/30 via-transparent to-transparent 
					rounded-b-full
				...
				<div className="absolute inset-y-0 left-0 w-12 
					bg-gradient-to-r from-yellow-300/30 to-transparent 
					rounded-l-full"
				/>
				<div className="absolute inset-y-0 right-0 w-12 
					bg-gradient-to-l from-yellow-600/20 to-transparent 
					rounded-r-full"
				/>
