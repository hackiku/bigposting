...
interface ShortTestimonialProps {
	quote: string;
	name: string;
	role: string;
	avatar: string;
...
export function ShortTestimonial({ quote, name, role, avatar }: ShortTestimonialProps) {
	return (
		<div className="max-w-3xl mx-auto my-12 px-4">
			<div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 relative">
				{/* Quote icon */}
				<div className="absolute -top-4 left-8">
					<div className="rounded-full p-3 shadow-lg bg-gradient-to-br from-brand-green to-teal-600">
